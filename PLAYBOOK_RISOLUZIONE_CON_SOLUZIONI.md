...
|---|---|
| Cyber | `DDOS_GATEWAY` |
| Information | `LEAK_COORDINATO` |
| Cognitive | `CONFUSIONE_COMANDO` |
| Physical | `AIS_IMPOSSIBILE` |

Flag finale:

```text
FLAG{DDOS_GATEWAY_LEAK_COORDINATO_CONFUSIONE_COMANDO_AIS_IMPOSSIBILE}
```
...
| Dominio | Token |
|---|---|
| Cyber | `TTP_CONVERGENTI` |
| Information | `NARRATIVA_ALLINEATA` |
| Cognitive | `CONFIDENCE_MEDIO` |
| Physical | `MITIGAZIONI_DIFENSIVE` |

Flag finale:

```text
FLAG{TTP_CONVERGENTI_NARRATIVA_ALLINEATA_CONFIDENCE_MEDIO_MITIGAZIONI_DIFENSIVE}
```
...
|---|---|
| Cyber | `IOC_ESTRATTI` |
| Information | `FATTI_INFERENZE` |
| Cognitive | `NON_ESEGUIRE` |
| Physical | `YARA_DIDATTICA` |

Flag finale:

```text
FLAG{IOC_ESTRATTI_FATTI_INFERENZE_NON_ESEGUIRE_YARA_DIDATTICA}
```
...
| Dominio | Token |
|---|---|
| Cyber | `SCHEDULED_TASK` |
| Information | `BEACON_C2` |
| Cognitive | `ORDINI_NON_FIDATI` |
| Physical | `SHARE_NAVIGAZIONE` |

Flag finale:

```text
FLAG{SCHEDULED_TASK_BEACON_C2_ORDINI_NON_FIDATI_SHARE_NAVIGAZIONE}
```
...
|---|---|
| Cyber | `IOC_VALIDATI` |
| Information | `TIMELINE_UNICA` |
| Cognitive | `CONFIDENCE_LEVEL` |
| Physical | `AZIONI_24H` |

Flag finale:

```text
FLAG{IOC_VALIDATI_TIMELINE_UNICA_CONFIDENCE_LEVEL_AZIONI_24H}
```
...
| Dominio | Token |
|---|---|
| Cyber | `DETECTION_TIME` |
| Information | `IMPACT_REDUCTION` |
| Cognitive | `TEAM_COORDINATION` |
| Physical | `MISSION_SOSTENIBILE` |

Flag finale:

```text
FLAG{DETECTION_TIME_IMPACT_REDUCTION_TEAM_COORDINATION_MISSION_SOSTENIBILE}
```
